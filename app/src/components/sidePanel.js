      ...
      <div className="side-panel-container">
        ...
        <div className="header-navigation">
          <div
            ...
            onClick={() => this.onNavBarElementClick()}
          >
            <Link to="/">
          ...
          <div className="linkedIn nav-item">
            <a
              href="https://www.linkedin.com/in/zarifshahriar/"
              target="_blank"
            >
              <i className="fab fa-linkedin-in" style={iconStyle} />
            </a>
          </div>
          ...
          <div className="resume nav-item">
            <a
              href={require('../documents/zshahriar_resume.pdf')}
              target="_blank"
            >
              <i className="fas fa-address-card" style={iconStyle} />
            </a>
          </div>
        </div>
